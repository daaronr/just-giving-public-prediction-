...
rmarkdown::render(here("codebooks","codebook_ucfdd.Rmd"), output_dir=here("codebooks"), intermediates_dir = here("codebooks"), knit_root_dir=here("codebooks")) 

#rmarkdown::render(here("")) #codebook for donation data, completed pages (1 observation per donation)
